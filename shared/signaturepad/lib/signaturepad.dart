...
/// Signature used by [SignaturePad] for [SignaturePad.onDraw] callback.
typedef SignatureDrawCallback = void Function(Offset offset, DateTime time);

/// Signature used by [SignaturePad] for [SignaturePad.onDrawStart]
/// callback.
...
///
/// You can customize the [SignaturePad] with below options.
...
/// * The stroke color of the [SignaturePad] can be customized using the
/// [strokeColor] property.
/// * The background color of the [SignaturePad] can be customized using the
/// [backgroundColor] property.
///
/// The [onDrawStart], [onDraw] and [onDrawEnd] allows you to handle the
/// gestures in [SignaturePad]
///
/// The [SignaturePadState.toImage] allows you to export the signature in
/// [SignaturePad] to an image.
/// The [SignaturePadState.clear] allows you to clear all the signature
/// strokes in [SignaturePad].
/// The [SignaturePadState.renderToContext2D] allows you to export the
/// signature in [SignaturePad] to a html canvas.
/// [SignaturePadState.renderToContext2D] is used to export the signature as
/// an image in web platform.
///
/// Note - Since the [SignaturePadState.toImage], [SignaturePadState.clear]
/// and [SignaturePadState.renderToContext2D] are defined in state object of
/// [SignaturePad], you have to use a global key assigned to the
/// [SignaturePad] instance to call these methods.
///
/// ## Example
///
/// This snippet shows how to use a [SignaturePad].
///
/// * Create a global key for [SignaturePadState].
/// ```dart
/// final GlobalKey<SignaturePadState> _signaturePadKey = GlobalKey();
/// ```
/// * Create the [SignaturePad] and set the properties and global key.
/// ```dart
/// SignaturePad(
...
/// [SignaturePad] from [onDrawStart], [onDraw] and [onDrawEnd].
/// ```dart
/// SignaturePad(
///   onDrawStart: () {
///     return false;
...
///   });
/// ```
/// * Call [SignaturePadState.clear] using state object to clear all the drawn
/// strokes in the [SignaturePad].
/// ```dart
/// _signaturePadKey.currentState!.clear();
/// ```
/// * Call [SignaturePadState.toImage] using state object to convert the
/// signature to an image representation.
/// ```dart
/// ui.Image image = await _signaturePadKey.currentState!.toImage();
/// ```
class SignaturePad extends StatefulWidget {
  /// Constructor that creates a new instance of [SignaturePad].
  ///
  /// The below snippet shows how to use a [SignaturePad].
  ///
  /// * Create a global key.
  /// ```dart
  /// final GlobalKey<SignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignaturePad] and set the properties and global key.
  /// ```dart
  /// SignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ///   maximumStrokeWidth: 6.0,
  ...
  /// ```
  ///
  /// * Call [SignaturePadState.clear] using state object to clear all the
  /// drawn strokes in the [SignaturePad].
  /// ```dart
  /// _signaturePadKey.currentState.clear();
  ///```
  ///
  ...
  /// ui.Image image = await _signaturePadKey.currentState.toImage();
  /// ```
  /// * Handle the start of signature gestures in [SignaturePad] from
  /// [onDrawStart].
  /// ```dart
  /// SignaturePad(
  ///   onDrawStart: () {
  ...
  ///   });
  /// ```
  /// * Handle the ondraw of signature gestures in [SignaturePad] from
  /// [onDraw].
  /// ```dart
  /// SignaturePad(
  ///   onDraw: (offset, time) {
  ...
  ///   });
  /// ```
  /// * Handle the end of signature gestures in [SignaturePad] from
  /// [onDrawEnd].
  /// ```dart
  ///  SignaturePad(
  ///    onDrawEnd: ()=> {
  ...
  ///
  /// The stroke will be drawn in [SignaturePad] based on the speed of the
  /// stroke gesture within its minimum and maximum stroke width ranges.
  /// So that the signature will be more realistic.
  ///
  /// This snippet shows how to set stroke width in [SignaturePad].
  ///
  /// ```dart
  /// SignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ...
  /// So that the signature will be more realistic.
  ///
  /// This snippet shows how to set the stroke width in [SignaturePad].
  ///
  /// ```dart
  /// SignaturePad(
  ///   minimumStrokeWidth: 3.0,
  ...
  /// Color applied to the background of [SignaturePad].
  ///
  /// The default [backgroundColor] is `Colors.transparent`.
  ///
  /// This snippet shows how to set a background color for [SignaturePad].
  ///
  /// ```dart
  /// SignaturePad(
  ///   backgroundColor: Colors.white,
  ...
  ///
  /// This snippet shows how to set the stroke color for [SignaturePad].
  ///
  /// ```dart
  ///
  /// SignaturePad(
  ...
  /// Called when the user starts signing on [SignaturePad].
  ///
  /// This snippet shows how to set [onDrawStart] callback in [SignaturePad].
  ///
  /// ```dart
  /// SignaturePad(
  ///   onDrawStart: () {
  ...
  /// Called when a stroke is updated on the [SignaturePad].
  ///
  /// This snippet shows how to set [onDraw] callback in [SignaturePad].
  ///
  /// ```dart
  /// SignaturePad(
  ///   onDraw: (offset, time) {
  ...
  /// Called when the user completes signing on [SignaturePad].
  ///
  /// This snippet shows how to set [onDrawEnd] callback in [SignaturePad].
  ///
  /// ```dart
  ///
  /// SignaturePad(
...
/// This class maintains the state of the [SignaturePad] widget.
class SignaturePadState extends State<SignaturePad> {
  /// Creates an unmodifiable ui.Path collection which represents the strokes in
  /// the [SignaturePad].
  ///
  /// Since this method is defined in the state object of [SignaturePad],
  /// you have to use a global key assigned to the [SignaturePad] to call this
  /// method.
  /// This snippet shows how to use [toPathList] in [SignaturePadState].
  ///
  ///
  /// * Create a global key.
  /// ```dart
  /// final GlobalKey<SignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignaturePad] instance and assign the global key to it.
  /// ```dart
  /// SignaturePad(
  ///   key: _signaturePadKey,
  ///  );
  ...
  ///
  /// Since this method is defined in the state object of [SignaturePad],
  /// you have to use a global key assigned to the [SignaturePad] instance
  /// to call this method.
  ///
  /// This snippet shows how to use [toImage] in [SignaturePadState].
  ///
  ///
  /// * Create a global key.
  /// ```dart
  /// final GlobalKey<SignaturePadState> _signaturePadKey = GlobalKey();
  ///```
  /// * Create a [SignaturePad] and assign the global key to it.
  /// ```dart
  /// SignaturePad(
  ///   key: _signaturePadKey,
  ///  );
  ...
  /// Clears all the signature strokes in the [SignaturePad].
  ///
  /// Since this method is defined in the state object of [SignaturePad],
  /// you have to use a global key assigned to the [SignaturePad] to call this
  /// method.
  /// This snippet shows how to use [clear] in [SignaturePadState].
  ///
  ///
  /// * Create a global key.
  /// ```dart
  ...
  Widget build(BuildContext context) {
    ...
    return _SignaturePadRenderObjectWidget(
...
class _SignaturePadRenderObjectWidget extends LeafRenderObjectWidget {
  const _SignaturePadRenderObjectWidget({
...
/// A render object for [SignaturePad] widget.
